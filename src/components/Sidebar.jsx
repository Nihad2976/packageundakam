    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'mobile-open' : ''}`}>
        ...
        {!isHome ? (
          ...
          /* Full Dashboard View: Action buttons & navigation menu */
          <>
            <div className="sidebar-actions">
              <Link to="/quotation/new" className="btn sidebar-btn sidebar-btn-quotation">
                + NEW QUOTATION
              </Link>
              <Link to="/invoice/new" className="btn sidebar-btn sidebar-btn-invoice">
                + NEW INVOICE
              </Link>
            </div>
            ...
            <nav className="sidebar-nav">
              <button
                type="button"
                className={`sidebar-nav-item ${isHome && activeTab === 'all' ? 'active' : ''}`}
              ...
              <button
                type="button"
                className={`sidebar-nav-item ${isHome && activeTab === 'quotation' ? 'active' : ''}`}
              ...
              <button
                type="button"
                className={`sidebar-nav-item ${isHome && activeTab === 'invoice' ? 'active' : ''}`}
